class Gofs < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/samzong/mm/releases/download/v#{version}/gofs-darwin-arm64"
      sha256 "46a9d07644a71c7206f804a54e6ee4f7179e2ae1bb103c7aed6815a0e7529fbf"
    else
      url "https://github.com/samzong/mm/releases/download/v#{version}/gofs-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/samzong/mm/releases/download/v#{version}/gofs-linux-arm64"
      sha256 "828b85f5ff07545d04f5c648f18478f8ee37e194e437698f8f60891af9760f51"
    else
      url "https://github.com/samzong/mm/releases/download/v#{version}/gofs-linux-amd64"
