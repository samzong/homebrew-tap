...
| gmc | CLI Tool | CLI for that accelerates the efficiency of Git add and commit | v0.10.0 |
...
| recall | CLI Tool | Local-first TUI for searching AI coding session history | v0.5.9 |
