...
| gmc | CLI Tool | CLI for that accelerates the efficiency of Git add and commit | v0.6.1 |
...
| GitHub Notifier | GUI App | A macOS menu bar app for GitHub notifications | v0.2.0 |
